...
{
    public class LivrosEnricher : ContentResponseEnricher<LivrosVO>
    {
        private readonly object _lock = new object();
        protected override Task EnrichModel(LivrosVO content, IUrlHelper urlHelper)
        {
            var patch = "api/livros";
